main.pdf: main.tex .PHONY references.bib figures/incidence_England.pdf figures/incidence_stratified.pdf figures/rw.pdf figures/children.pdf figures/gof.pdf
	python3 latexrun $<
