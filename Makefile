main.pdf: main.tex .PHONY references.bib figures/incidence_England.pdf figures/incidence_stratified.pdf figures/incidence_cutoffs.pdf figures/incidence_cutoffs_region.pdf figures/rw_London.pdf figures/rw_non-London.pdf figures/children.pdf figures/gof.pdf
	python3 latexrun $<
