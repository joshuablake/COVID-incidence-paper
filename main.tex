...
We fit two models to the X positive and Y negative tests in CIS between DATES in England.
...
Like all phenomenological models, it does not represent any aspect of the disease or population within the model; this allows us to use a computationally-efficient inference methodology, the integrated Laplace approximation (INLA) and incorporate many parameters for the granular stratification while penalizing overfitting.
...
Both models successfully produce estimates of SARS-CoV-2 incidence proportion, the proportion of the population that becomes PCR positive on a given day (\cref{fig:incidence-Eng}).
