...
Therefore, when fitting, it appears to compromise these two age groups in opposite directions: overestimating the prevalence and incidence in the 12--16 age group and underestimating it in the 17--25 age group (TODO).
...
We estimate that this component initially decreases, is flat for a few weeks, then rises in November and December (\cref{fig:rw} and TODO).
...
\caption{%
    ...
    London shown, for other regions see TODO.
}
\label{fig:rw}
\end{figure}
...
We used weakly informative priors for all other parameters (TODO).
