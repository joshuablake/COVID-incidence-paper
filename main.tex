...
Age-specific results for the North East region clearly show the impact of model assumptions on the estimates (\cref{fig:incidence-strat}(B)).
The 12--16 age group decreases in incidence significantly during the school half-term break which is directly introduced into the model through modification of the number of contacts which school age children have, informed by school attendance data (Methods and Materials).
