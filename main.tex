...
We approximate the posterior of this proportion with a beta distribution to form the prior for the mechenastic analysis (see \cref{SEIR:table:immunity-prior}).
