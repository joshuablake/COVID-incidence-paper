...
The largest disagreement between the models is that the phenomenological model estimates a second peak in incidence in January for England (\cref{fig:incidence-Eng}), although the credible intervals overlap for the majority of the period.
...
The decrease in contact rates flows through into the incidence estimates from the mechanistic model at this time.
...
We estimate that this component initially decreases over the period studied (from September 2020), is flat for a few weeks, then rises in November and December (\cref{fig:rw} and TODO).
